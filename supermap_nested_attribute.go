...
type SuperMapNestedAttribute struct {
	...
	Ephemeral  *schemaE.MapNestedAttribute
...
func (s SuperMapNestedAttribute) IsEphemeral() bool {
...
//nolint:dupl
func (s SuperMapNestedAttribute) GetEphemeral(ctx context.Context) schemaE.Attribute {
	var (
		common    schemaR.MapNestedAttribute
		ephemeral schemaE.MapNestedAttribute
	)
...
// IsEphemeral returns true if the attribute is a ephemeral attribute.
func (s SuperMapNestedAttributeOf[T]) IsEphemeral() bool {
	return s.Ephemeral != nil || s.Common != nil
}
...
//nolint:dupl
func (s SuperMapNestedAttributeOf[T]) GetEphemeral(ctx context.Context) schemaE.Attribute {
	var (
		common    schemaR.MapNestedAttribute
		ephemeral schemaE.MapNestedAttribute
	)
