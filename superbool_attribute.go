...
type SuperBoolAttribute struct {
	...
	Ephemeral  *schemaE.BoolAttribute
}
...
func (s SuperBoolAttribute) IsEphemeral() bool {
...
//nolint:dupl
func (s SuperBoolAttribute) GetEphemeral(ctx context.Context) schemaE.Attribute {
	var (
		common    schemaR.BoolAttribute
		ephemeral schemaE.BoolAttribute
	)
