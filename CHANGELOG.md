...
* deps: bumps github.com/orange-cloudavenue/terraform-plugin-framework-supertypes from 1.1.0 to 1.2.0 (GH-36)
...
* Improves markdown generation for the resource. Now the `default` description is placed before the `validators` descriptions. And now the `(ForceNew)` is colored red (Force new is generated by the hasicorp plan modifier `RequiresReplace`). (GH-28)
