...
type SuperInt64Attribute struct {
	...
	Ephemeral  *schemaE.Int64Attribute
}
...
func (s SuperInt64Attribute) IsEphemeral() bool {
...
//nolint:dupl
func (s SuperInt64Attribute) GetEphemeral(ctx context.Context) schemaE.Attribute {
	var (
		common    schemaR.Int64Attribute
		ephemeral schemaE.Int64Attribute
	)
