...
type SuperNumberAttribute struct {
	...
	Ephemeral  *schemaE.NumberAttribute
}
...
func (s SuperNumberAttribute) IsEphemeral() bool {
...
//nolint:dupl
func (s SuperNumberAttribute) GetEphemeral(ctx context.Context) schemaE.Attribute {
	var (
		common    schemaR.NumberAttribute
		ephemeral schemaE.NumberAttribute
	)
