...
type SuperListNestedAttribute struct {
	...
	Ephemeral  *schemaE.ListNestedAttribute
...
func (s SuperListNestedAttribute) IsEphemeral() bool {
...
//nolint:dupl
func (s SuperListNestedAttribute) GetEphemeral(ctx context.Context) schemaE.Attribute {
	var (
		common    schemaR.ListNestedAttribute
		ephemeral schemaE.ListNestedAttribute
	)
...
// IsEphemeral returns true if the attribute is a ephemeral attribute.
func (s SuperListNestedAttributeOf[T]) IsEphemeral() bool {
	return s.Ephemeral != nil || s.Common != nil
}
...
//nolint:dupl
func (s SuperListNestedAttributeOf[T]) GetEphemeral(ctx context.Context) schemaE.Attribute {
	var (
		common    schemaR.ListNestedAttribute
		ephemeral schemaE.ListNestedAttribute
	)
